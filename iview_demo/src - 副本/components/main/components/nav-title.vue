<template>
  <div class="layout nav">
    <div class="shop-box">
      <div @mouseleave="titleMouseLeave"  @mouseenter="titleMouseEnter" class="shop-title"><span>商品分类</span><Icon class="jiantou_one" type="ios-arrow-down" />
      <div class=" shop-content" :style='contentStyle'  v-show="showMenu">
    ...
    <div class="nav-center"> 
        ...
        <router-link active-class="active-title" class="nav-title" tag="span" :to="{path:'home'}" ><span>首页</span></router-link>
        <router-link active-class="active-title"  class="nav-title" tag="span" :to="{path:'inspiration'}" ><span>灵感</span></router-link>
        <router-link active-class="active-title"  class="nav-title" tag="span" :to="{path:'business'}" ><span>对公业务</span></router-link>
    </div>
