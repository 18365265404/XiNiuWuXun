  ...
  <div class="shop-center">
      ...
      <div class="shop-list">
          <ul class="layout sort">
              <li @click="sort(0)" :class="{'sort-active': sortActive==0}"><span>综合</span></li>
              <li @click="sort(1)" :class="{'sort-active': sortActive==1}"><span>价格</span><Icon class="sort-icon" :type="ifPriceUp ? 'md-arrow-round-up' : 'md-arrow-round-down'"  /></li>
          </ul>
