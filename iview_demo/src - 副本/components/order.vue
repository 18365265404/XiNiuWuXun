    ...
    <div class="order">
        <div class="order-type">
            <div class="type-left">
                ...
                <span :class="{active: 2==activeIndex}" @click="showOrder()">待收货</span>
                <span :class="{active: 3==activeIndex}" @click="showOrder()">已签收</span>
            </div>
        ...
        <ul class="table-head">
            <li  class="date-choose cursor" >
                <div v-unThisClick="unThisClick" class="dateName" @click="showDateB">
                    <span>{{dateVal}}</span>
                    <!-- <Icon class="jiantou"  type="ios-arrow-down" /> -->
                </div>
